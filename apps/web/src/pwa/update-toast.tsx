...
export function UpdateToast({
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1 text-copy">A new version of OpenDoist is available</span>
      <button
        type="button"
        onClick={onReload}
        className="shrink-0 cursor-pointer rounded-sm bg-white/15 px-2 py-1 font-medium text-copy text-white transition-colors duration-150 hover:bg-white/25 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--od-focus-ring)]"
      >
        Reload
      </button>
      <button
